(function(a) {
    a.extend(a.easing, {
        easeInOutCubic: function(a, b, d, k, f) {
            return 1 > (b /= f / 2) ? k / 2 * b * b * b + d : k / 2 * ((b -= 2) * b * b + 2) + d
        }
    });
    ...
    (function(a, b) {
        var d = function(a, b, e) {
            ...
            return function() {
                var c = this,
                    g = arguments;
                d ? clearTimeout(d) : e && a.apply(c, g);
    ...
    a.isMobile = function(e) {
        ...
        e = "undefined" == a.type(e) ? "*" : e.toLowerCase();
        "*" == e ? b = a.map(d, function(a) {
            return a
        }) : e in d && b.push(d[e]);
        return !(!b.length || !navigator.userAgent.match(new RegExp(b.join("|"), "i")))
    };
    var n = function() {
        var e = a('<div style="height: 50vh; position: absolute; top: -1000px; left: -1000px;">').appendTo("body"),
            b = e[0],
    ...
    a(function() {
        ...
        a(document).on("add.cards change.cards", function(c) {
            a(c.target).outerFind(".mbr-hamburger:not(.mbr-added)").each(function() {
        ...
        a(window).smartresize(function() {
            ...
            27 == c.which && a(".mbr-hamburger--open").click()
        });
        a.isMobile() && navigator.userAgent.match(/Chrome/i) ? function(c, g) {
            var b = [c, c];
            b[g > c ? 0 : 1] = g;
            a(window).smartresize(function() {
                var c = a(window).height();
                0 > a.inArray(c, b) && (c = b[a(window).width() > c ? 1 : 0]);
                a(".mbr-section--full-height").css("height", c + "px")
            })
        }(a(window).width(), a(window).height()) : n || (a(window).smartresize(function() {
        ...
        a(window).smartresize(function() {
            a(".mbr-section--16by9").each(e)
        });
        a(document).on("add.cards change.cards", function(c) {
            var b = a(c.target).outerFind(".mbr-section--16by9");
            b.length ? b.attr("data-16by9", "true").each(e) : a(c.target).outerFind("[data-16by9]").css("height", "").removeAttr("data-16by9")
        });
        a.fn.jarallax && !a.isMobile() &&
            (a(document).on("destroy.parallax", function(c) {
                ...
                a(c.target).outerFind(".mbr-parallax-background").jarallax().css("position", "relative")
            }));
        ...
        a(window).scroll(function() {
            ...
            k = c;
            if (f) {
                var e = c > f.breakPoint;
                b ? e != f.fixed && (l ? (f.fixed = e, a(f.elm).toggleClass("is-fixed")) : d = setTimeout(function() {
                    f.fixed = e;
        ...
        var m = function() {
            var c = a(this),
                ...
                d = a.extend({
                    ...
                    markerIcon: null,
                    showInfo: !0
                }, eval("(" + (c.data("google-map-params") || "{}") + ")"));
            c.find(".mbr-google-map__marker").each(function() {
                var c = a(this).data("coordinates");
                c && b.push({
                    coord: c.split(/\s*,\s*/),
            ...
            if (b.length) {
                ...
                a.each(b, function(a, c) {
                    var b = new google.maps.Marker({
                        ...
                        g = b.InfoWindow = new google.maps.InfoWindow;
                    g._setContent = g.setContent;
                    g.setContent = function(a) {
                        return this._setContent(a ? c.template.replace("{{content}}", a) : "")
                    };
                    g.setContent(c.content);
                    google.maps.event.addListener(b, "click", function() {
                        g.anchor && g.anchor.visible ? g.close() : g.getContent() && g.open(h, b)
                    });
                    c.content && d.showInfo && google.maps.event.addListenerOnce(b,
                        "animation_changed",
                        function() {
                            setTimeout(function() {
                                g.open(h, b)
        ...
        a(document).on("add.cards", function(c) {
            window.google && google.maps && a(c.target).outerFind(".mbr-google-map").each(function() {
                m.call(this)
            })
        });
        a(window).smartresize(function() {
        ...
        a(document).on("add.cards", function(c) {
            a(c.target).outerFind("[data-bg-video]").each(function() {
                for (var c, b = a(this).data("bg-video"), d = [/\?v=([^&]+)/, /(?:embed|\.be)\/([-a-z0-9_]+)/i, /^([-a-z0-9_]+)$/i], e = 0; e < d.length; e++)
                    if (c = d[e].exec(b)) {
                        var b = "http" + ("https:" == location.protocol ? "s" : "") + ":",
                            b = b + ("//img.youtube.com/vi/" + c[1] + "/maxresdefault.jpg"),
                            f = a('<div class="mbr-background-video-preview">').hide().css({
                        ...
                        a("<img>").on("load", function() {
                            ...
                            } else f.css("background-image", 'url("' + this.src + '")').show()
                        }).attr("src", b);
                        a.fn.YTPlayer && !a.isMobile() && (b = eval("(" + (a(this).data("bg-video-params") || "{}") + ")"), a(".container:eq(0)", this).before('<div class="mbr-background-video"></div>').prev().YTPlayer(a.extend({
                            videoURL: c[1],
                            containment: "self",
                            showControls: !1,
                            mute: !0
        ...
        a("html").hasClass("is-builder") || a(document).click(function(c) {
            try {
                var b = c.target;
                if (!a(b).parents().hasClass("mbr-gallery") || !a(b).parents().hasClass("carousel") && !a(b).parent().is("a")) {
                    do
                        if (b.hash) {
                            var d = /#bottom|#top/g.test(b.hash);
                            a(d ? "body" : b.hash).each(function() {
                                c.preventDefault();
                                var d = a(".mbr-navbar--sticky").length ?
                                    64 : 0,
    ...
    a(document).on("change", 'input[type="range"]', function(e) {
        a(e.target).parents(".form-group").find(".value")[0].innerHTML = e.target.value
    })
})(jQuery);
! function() {
    try {
